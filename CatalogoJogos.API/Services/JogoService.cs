...
namespace CatalogoJogos.API.Services
{
    public class JogoService : IJogoService
    {
        ...
        public JogoService ( IJogoRepository jogoRespository )
        {
            _jogoRepository = jogoRespository;
        }
        ...
        //usamos para fechar a conexão com o banco de dados, alguns bancos tem limites de conexões simultaneas 
        public void Dispose()
        {
