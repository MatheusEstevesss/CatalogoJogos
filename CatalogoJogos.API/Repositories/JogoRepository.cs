...
namespace CatalogoJogos.API.Repositories
{
    public class JogoRepository : IJogoRepository
    {
        ...
        {
            { Guid.Parse("0ca314a5-9282-45d8-82c3-2985f2a9fd04"), new Jogo{ Id = Guid.Parse("0ca314a5-9282-45d8-82c3-2985f2a9fd04"), Nome = "Fifa 21", Produtora = "EA", Preco = 200} },
            ...
            { Guid.Parse("92576db2-388e-4f5d-96c1-8bfda6c5a268"), new Jogo{ Id = Guid.Parse("92576db2-388e-4f5d-96c1-8bfda6c5a268"), Nome = "Street Fighter V", Produtora = "Capcom", Preco = 80} },
        ...
        // apenas um exemplo de como fazer o método obter sem a expressão lambda
