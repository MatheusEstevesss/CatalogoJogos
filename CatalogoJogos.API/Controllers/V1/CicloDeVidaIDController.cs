...
namespace CatalogoJogos.API.Controllers.V1
{
    ...
    {
        //como se fosse uma classe estática, gera uma instancia do que é pedido e a mantem até a aplicação sair do ar (caso haja um f5 não vai mudar)
        public readonly IExemploSingleton _exemploSingleton1;
        public readonly IExemploSingleton _exemploSingleton2;

        //Uma instancia que fica durante toda a requisição (se estiver fazendo 2 gets, ambos serão iguais)
        public readonly IExemploScoped _exemploScoped1;
        public readonly IExemploScoped _exemploScoped2;

        //A cada vez que vc o entrega dados ele gera uma nova instancia (se estiver fazendo 2 gets, serão diferente)
